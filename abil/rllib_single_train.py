...
def main(
    ...
    tune_config = {
        ...
        "env_config": {
            ...
            "agent_specs": {
                f"AGENT-{0}": rllib_agent["agent_spec"]
            },
        },
    ...
    experiment_name = f"rllib_single_{os.path.basename(os.path.normpath(scenario))}"
...
if __name__ == "__main__":
    ...
    # parser.add_argument(
    #     "--algo", help="RL algorithm to use, e.g: PPO, PG, SAC", default='PG', type=str
    # )
    parser.add_argument(
        "--headless",
        action="store_true",
    ...
    parser.add_argument(
        ...
        # default='~/ray_results/rllib_single_2lane/PPO_RLlibHiWayEnv_39e64_00000_0_seed=125_2021-05-30_20-35-05/checkpoint_1/checkpoint-1'
        default=None
    )
